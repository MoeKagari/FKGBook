...
public class CharacterInformation extends AbstractCharaData {
	...
	public static void main(String[] args) {
		GetMasterData.get("masterCharacter", CharacterInformation::new)
				.stream().filter(AbstractCharaData::canShowInApplication)
				.filter(chara -> !chara.isBloomChara())
				.filter(chara -> !chara.isOriginalChara())
				.forEach(chara -> System.out.println(chara.getId() + chara.getName()));
	}
	...
	public CharacterInformation(String source) {
		...
		this.character_name = gmdls.next();
	...
	@Override
	public boolean isOriginalChara() {
