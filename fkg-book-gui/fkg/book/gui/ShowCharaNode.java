...
public class ShowCharaNode extends VBox {
	...
	class ShowStandWindow {
		...
		ShowStandWindow(int width, int height) {
			...
			FunctionUtils.use(new java.awt.event.MouseAdapter() {
	...
	class SkillBox extends VBox {
		...
		void updateSkill(AbstractCharaData chara) {
			...
			//能力
			FunctionUtils.forEach(this.abilityTexts, chara.getAbility().abilityArray, (abilityText, ability) -> abilityText.setText(ability.getDescription()));
		}
	}
}
