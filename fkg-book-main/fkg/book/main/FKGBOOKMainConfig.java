...
public class FKGBOOKMainConfig {
	...
	/** 备份masterdata */
	private boolean makeBackupForMasterData = true;
	/** 替换副团长 */
	...
	public boolean isMakeBackupForMasterData() {
		return this.makeBackupForMasterData;
	}

	public void setMakeBackupForMasterData(boolean makeBackupForMasterData) {
		this.makeBackupForMasterData = makeBackupForMasterData;
	}
}
