...
public class CharacterInformation implements GetMasterData {
	...
	public static CharacterInformation getElement(List<GetMasterData> cis, int id) {
	...
	public GetMasterData[] getSkill(List<GetMasterData> css, List<GetMasterData> clss) {
		return new GetMasterData[] { CharacterLeaderSkill.getElement(clss, this.passiveSkill1), CharacterLeaderSkill.getElement(clss, this.passiveSkill2), CharacterSkill.getElement(css, this.activeSkill) };
	}
